<?php function thb_progressbar( $atts, $content = null ) {
	...
	foreach($graph_lines_data as $line) {
	    ...
	    $output .= '<div class="progress_bar '.$style.'">';
	    ...
	    $output .= '<span class="bar '.$bgcolor.'" data-value="'.$line['value'].'"><span class="progress"><div class="tooltip in top"><div class="tooltip-inner"></div><div class="tooltip-arrow"></div></div></span></span>';
	    $output .= '</div>';
	}
	return $output;
