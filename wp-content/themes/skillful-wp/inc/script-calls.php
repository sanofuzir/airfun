...
function register_js() {
	...
	if (!is_admin()) {
		...
		// Register 
		wp_register_script('modernizr', THB_THEME_ROOT . '/assets/js/modernizr.foundation.js', 'jquery', null);
		...
		wp_register_script('superfish', THB_THEME_ROOT . '/assets/js/jquery.superfish.js', 'jquery', null, TRUE);
		...
		wp_register_script('knob', THB_THEME_ROOT . '/assets/js/jquery.knob.min.js', 'jquery', null, TRUE);
		...
		wp_register_script('isotope_theme', THB_THEME_ROOT . '/assets/js/jquery.isotope.min.js', 'jquery', null, TRUE);
		wp_register_script('tooltip', THB_THEME_ROOT . '/assets/js/jquery.tooltip.min.js', 'jquery', null, TRUE);
...
function single_scripts() {
	if (is_singular('post') || is_singular('portfolio') || is_attachment() || is_singular('product')) {
...
function isotope_scripts() {
	if (is_page_template('template-portfolio.php') || 
			is_page_template('template-blog-masonry.php') || 
			is_page_template('template-blog-list.php')) {
...
add_action('wp_enqueue_scripts', 'jplayer_scripts');
