			...
			switch(name) {
				...
				case 'thb_button':
					var size = $('input[name='+name+'-size]:checked').val() || 'small',
							...
							rounded = $('input[name='+name+'-rounded]:checked').val() || '',
							outline = $('input[name='+name+'-outline]:checked').val() || '',
					...
					content = '[thb_button link="'+link+'" style="'+outline+'" rounded="'+rounded+'" color="'+color+'" icon="'+icon+'" size="'+size+'" animation="'+animation+'" '+target_blank+']'+title+'[/thb_button]';
