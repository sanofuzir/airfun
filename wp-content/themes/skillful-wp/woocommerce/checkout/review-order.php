...
<?php if ( ! is_ajax() ) : ?><section class="section" id="order_review"><?php endif; ?>
		<h2><?php _e( 'Your Order',THB_THEME_NAME ); ?></h2>
	...
	<?php do_action( 'woocommerce_review_order_before_payment' ); ?>
		...
		<div id="payment">
			...
			<h2><?php _e( 'Payment Method',THB_THEME_NAME ); ?></h2>
		...
		<div class="form-row place-order">
			...
			<?php if ( wc_get_page_id( 'terms' ) > 0 && apply_filters( 'woocommerce_checkout_show_terms', true ) ) {
				...
				?>
				<div class="small-12 medium-8 small-centered columns terms">
			...
			<?php } ?>
				...
				echo apply_filters( 'woocommerce_order_button_html', '<p><input type="submit" class="button alt" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" /></p>' );
				?>
			<?php if ( wc_get_page_id( 'terms' ) > 0 && apply_filters( 'woocommerce_checkout_show_terms', true ) ) { ?>
				</div>
			<?php } ?>
