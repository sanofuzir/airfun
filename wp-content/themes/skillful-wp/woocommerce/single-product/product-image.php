...
<div class="product-gallery">
	...
	<div id="product-images" class="carousel thumbnail_gallery product-images" data-thumbs="#product-nav" data-zoom="<?php echo $product_zoom; ?>" rel="gallery" data-columns="1">
	...
	<div id="product-nav" class="carousel product-nav" data-count="5">
        <?php if ( has_post_thumbnail() ) : 
        	$var_img = false;
        ...
        ?>
        	<img  src="<?php echo $image[0]; ?>" width="<?php echo $image[1]; ?>" height="<?php echo $image[2]; ?>" title="<?php echo $image_title; ?>" data-variation-color="<?php echo $var_img; ?>">
        <?php endif; ?>
