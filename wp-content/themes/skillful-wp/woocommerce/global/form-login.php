...
<form method="post" class="login" <?php if ( $hidden ) echo 'style="display:none;"'; ?>>
	...
	<div class="row">
		...
		<div class="small-12 columns">
			...
			<input type="submit" class="button outline login_button" name="login" value="<?php _e( 'Login', 'woocommerce' ); ?>" /><a href="<?php echo esc_url( wc_lostpassword_url() ); ?>" class="lost_password"><?php _e( 'Lost your password?', 'woocommerce' ); ?></a>
